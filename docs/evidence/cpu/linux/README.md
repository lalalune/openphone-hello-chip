...
- `sw/linux/dts/openagent-e1.dts` exposes RV64GC, Sv39, memory, CLINT, PLIC,
  ns16550 console, and `openagent,e1-*` MMIO nodes.
...
- Generate or import `build/chipyard/openagent_rocket/OpenAgentRocketConfig.manifest.json`.
...
- Run `scripts/run_chipyard_openagent_linux_smoke.sh` on a Linux host/container.
