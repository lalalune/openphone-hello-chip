...
| `make tier2-build`    | Invokes `scripts/build/docker_build_tier2.sh` to produce `build/sim/tier2/Image` and `build/initramfs/openagent_tier2.cpio.gz`. Requires a running Docker daemon. |
