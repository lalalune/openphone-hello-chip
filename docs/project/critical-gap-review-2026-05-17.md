...
| Board/package/PD/FPGA | `package/hello-demo-package.md` and `package: qfn64_placeholder` are not vendor package artifacts. | Placeholder / release blocker | Pinout/package docs exist for planning only. | Darwin must keep fabrication/tapeout gates blocked until vendor drawing/bond/footprint evidence exists. |
...
| Board/package/PD/FPGA | No real KiCad project exists. | Complete gap | `board/kicad/hello-demo/fab-notes.md` only. | Darwin must list missing schematic/PCB/ERC/DRC/Gerber/drill/BOM/PnP/DFM gates. |
