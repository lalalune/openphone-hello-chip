...
| LPDDR5X/LPDDR6 PHY | memory | Active | Critical | High | Any v0 artifact claims custom LPDDR PHY readiness. | Mixed-signal PHY, training, SI/PI, and package co-design fail. | Use COTS SoC memory subsystem for product path; model only in open RTL path. | `rtl/open_rtl_prototype_path.md`, `arch/memory-map.md` |
