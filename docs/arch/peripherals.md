...
| WiFi/Bluetooth module | `package/wifi-external-interface.yaml` | Product scaffold; not bonded in e1 chip; SDIO host, Bluetooth transport ownership, and firmware driver not implemented |
