...
nextpnr-ecp5 --85k --package CABGA381 --freq 25 --json board/fpga/build/hello_demo_fpga.json --lpf board/fpga/constraints/hello_demo_ulx3s.lpf --textcfg board/fpga/build/hello_demo_fpga.config --report board/fpga/reports/hello_demo_nextpnr.json
ecppack --svf board/fpga/build/hello_demo_fpga.svf board/fpga/build/hello_demo_fpga.config board/fpga/build/hello_demo_fpga.bit
```

For SRAM-only programming on a lab ULX3S:

```sh
openFPGALoader -b ulx3s board/fpga/build/hello_demo_fpga.bit
```
