...
MATRIX = ROOT / "docs/project/product-architecture-security-radio-sensors-optimization-2026-05-17.yaml"
...
def main() -> int:
    ...
    if data:
        ...
        if data.get("status") != "fail_closed_product_work_order":
            errors.append("product architecture optimization matrix must remain fail_closed_product_work_order")
