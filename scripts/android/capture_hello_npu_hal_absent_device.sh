...
set +e
{
	echo "openagent-evidence: target=local_host artifact=e1_npu_absent_device_probe"
	echo "openagent-evidence: claim_boundary=no_nnapi_acceleration_without_android_nnapi_hal_and_device_evidence"
