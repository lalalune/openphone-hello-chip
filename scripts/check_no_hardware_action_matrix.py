...
def main() -> int:
    ...
    for term in ("No Android support is claimed", "No silicon/board/product claim", "No benchmark passes"):
    ...
    for item in workstreams:
        ...
        if not isinstance(next_artifact, str) or not next_artifact:
            ...
            errors.append(f"{workstream_id}: next_artifact points at missing repo path {next_artifact}")
