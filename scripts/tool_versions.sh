...

{
    ...
    printf "repo_dir=%s\n" "$repo_dir"
    for tool in docker nix verilator yosys yosys-smtbmc sby z3 boolector openroad openlane nextpnr-ecp5 ecppack klayout magic netgen iverilog python3 make qemu-system-riscv64 renode kicad-cli; do
