...
#define HELLO_NPU_IOC_GET_PERF \
	_IOR(HELLO_NPU_IOC_MAGIC, 0x03, struct hello_npu_perf)
#define HELLO_NPU_IOC_SUBMIT_DESCRIPTORS \
	_IOWR(HELLO_NPU_IOC_MAGIC, 0x04, struct hello_npu_descriptor_submit)
#define HELLO_NPU_IOC_GET_COUNTERS \
	_IOR(HELLO_NPU_IOC_MAGIC, 0x05, struct hello_npu_counters)
